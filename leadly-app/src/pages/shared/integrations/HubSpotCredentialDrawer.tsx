      ...
      {loaded && (
        <div className="space-y-4">
          <IntegrationStatusBanner
            ...
            connectedText={t('integrations.hubspot.connected')}
            notConnectedText={t('integrations.hubspot.notConnected')}
          />
          ...
          <div className="flex items-center gap-2 border-t border-brand-100 pt-4">
            <Button type="button" variant="secondary" onClick={handleSubmit} disabled={submitting || !token.trim()}>
