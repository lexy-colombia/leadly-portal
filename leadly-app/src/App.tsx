              ...
              TenantLayout/RequireAuth (esos asumen una sesión). */}
                <Route path="/tienda/:slug" element={<StorefrontLayout />}>
                  ...
                  <Route
                    ...
                    element={<StorefrontProductDetail />}
                  />
                ...
                (Configuración) el 2026-08-16 -- ya no tiene ruta propia. */}
                  ...
                  <Route
                    path="sales"
                    element={
                      <RequireModule moduleKey="sales" action="sales.view">
                        <Orders />
                      </RequireModule>
                    }
                  />
                  ...
                  <Route
                    path="pos"
                    element={
                      <RequireModule moduleKey="pos" action="pos.view">
                        <Pos />
                      </RequireModule>
                    }
                  />
                  ...
                  <Route
                    path="returns"
                    element={
                      <RequireModule moduleKey="returns" action="returns.view">
                        <Returns />
                      </RequireModule>
                    }
                  />
                ...
                modules.ts. */}
                  <Route
                    path="expenses"
                    element={
                      <RequireModule moduleKey="expenses">
                        <Expenses />
                      </RequireModule>
                    }
                  />
                ...
                tiene ruta propia. */}
                  ...
                  <Route
                    path="integrations"
                    element={
                      <RequireModule moduleKey="integrations">
                        <TenantIntegrations />
                      </RequireModule>
                    }
                  />
