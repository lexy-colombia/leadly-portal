...
import { ImageIcon, XCircleIcon } from '@/components/atoms/icons'
import { Button } from '@/components/atoms'

/** Optional "attach image" control, e.g. used by OrderDetail's order
 * comment composer -- picks a file, previews it locally (no upload yet),
 * and hands the File up to the parent form. The parent uploads it only
 * after the parent row itself is created, since the attachment needs that
 * row's id first. */
