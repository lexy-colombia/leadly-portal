...
/** Casillas separadas (cada una con su propio borde redondeado completo),
 * no la píldora unida por defecto de shadcn -- pedido explícito del usuario
 * con una captura de referencia de ese estilo. */
