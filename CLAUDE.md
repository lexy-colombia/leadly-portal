...
- [~] **WhatsApp Embedded Signup** (self-service, cada tenant conecta su propia WABA) — código construido y desplegado el 2026-08-04 (ver Estado actual), bloqueado en que Meta apruebe el Tech Provider App Review + el usuario cree la Embedded Signup Configuration en el dashboard de Meta y comparta el `config_id`.
